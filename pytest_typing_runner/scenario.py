...
class ScenarioHook(Generic[T_Scenario]):
    """
    ...
    def __init__(
        ...
        *,
        ...
        Scenario: protocols.ScenarioMaker[T_Scenario],
    ) -> None:
        self.config = config
...
if TYPE_CHECKING:
    ...
    _A_RC: protocols.P_RunnerConfig = cast(C_RunnerConfig, None)
    _A_SM: protocols.P_ScenarioMaker = C_Scenario
    _A_SHM: protocols.P_ScenarioHookMaker = C_ScenarioHook

    _C_S: protocols.Scenario = cast(C_Scenario, None)
    _C_RC: protocols.RunnerConfig = cast(C_RunnerConfig, None)
    _C_SR: protocols.ScenarioRuns = cast(C_ScenarioRuns, None)
    _C_SH: protocols.ScenarioHook[C_Scenario] = cast(C_ScenarioHook, None)
    _C_SM: protocols.ScenarioMaker[C_Scenario] = C_Scenario
    _C_SHM: protocols.ScenarioHookMaker[C_Scenario] = C_ScenarioHook
