...
if TYPE_CHECKING:
    ...
    _C_SRS: protocols.ScenarioRuns[C_Scenario] = cast(C_ScenarioRuns, None)
    _C_SR: protocols.ScenarioRunner[C_Scenario] = cast(C_ScenarioRunner, None)
    _C_SH: protocols.ScenarioHook[C_Scenario] = cast(C_ScenarioHook, None)
    _C_SM: protocols.ScenarioMaker[C_Scenario] = C_Scenario.create
    _C_SHM: protocols.ScenarioHookMaker[C_Scenario] = C_ScenarioHook
    _C_SRM: protocols.ScenarioRunnerMaker[C_Scenario] = C_ScenarioRunner
