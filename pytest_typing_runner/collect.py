...
from .scenario import RunnerConfig, Scenario, ScenarioHook, T_Scenario
...
def typing_scenario_maker(
    typing_scenario_kls: protocols.ScenarioMaker[T_Scenario],
) -> protocols.ScenarioMaker[T_Scenario]:
...
def typing_runner_scenario(
    ...
    typing_scenario_kls: type[T_Scenario],
    typing_scenario_maker: protocols.ScenarioMaker[T_Scenario],
    typing_scenario_hook_maker: protocols.ScenarioHookMaker[T_Scenario],
    ...
    request.node.user_properties.append(("typing_runner", hook.scenario))
